    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Eu já lavei</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">O meu carro</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">E regulei</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">O som</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Cadastro de Departamento</h1>
            </div>

            <form action="<%= request.getContextPath() %>/departments/create" method="post">
