    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Edição de departamento</h1>
            </div>
            ...
            <form action="<%= request.getContextPath() %>/departments/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="id" name="field_id" value="<%= department.getId() %>" readonly>
                </div>"

                <div class="mb-3">
                    <label for="name" class="form-label">Nome: </label>
                    <input type="text" class="form-control" id="name" name="field_name" value="<%= department.getName() %>">
                </div>
